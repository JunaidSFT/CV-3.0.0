            ...
            Cell: (row) => (
              ...
              <Link to="/detail" className="text-blue"
			  	onClick = {()=> {
					...
					localStorage.setItem("customerName", row.row.original.payee_name);
					localStorage.setItem("customerAmount", row.row.original.pkr);
					localStorage.setItem("customerAmountWords", row.row.original.rupee);
					localStorage.setItem("customerDate", row.row.original.Date);
					localStorage.setItem("ID", row.row.original.id);
