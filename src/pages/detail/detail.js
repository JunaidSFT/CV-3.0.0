...
class Detail extends React.Component {
    ...
    handleCallback = (childData) =>{
        if (childData !== null && childData !== undefined ) {
            ...
            this.setState({
                chequeAmountNumeric: childData.original.pkr,
                chequeAmountWords : childData.original.rupee,
                customerName : childData.original.payee_name
            })
            localStorage.setItem("ID", childData.original.id);
    ...
    fetchImageData() {
        ...
        axios({
          ...
          data: {
            ...
            this.setState({ chequeImage: res.data.cheque_img_text,  loading: false}, () => console.log(res.data));
            }
            else{
                console.log(res)
                toast('No Data')
    ...
    SubmitAnnotations(){
            ...
            axios({
                ...
                url: `annots/add`,
                data:{
                    cheque_id : this.state.chequeNo, 
                    img_str : this.state.chequeImage, 
